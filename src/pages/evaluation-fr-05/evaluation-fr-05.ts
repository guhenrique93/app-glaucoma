...
export class EvaluationFR5Page {
  ...
  onSubmit(): void {
    if (!this.answer.why) {
      ...
      this.navCtrl.push(EvaluationFR6Page, {evaluation: this.evaluation});
    } else {
      this.answerWhy();
      
      this.navCtrl.push(EvaluationFRWhyPage, {destinationPage: EvaluationFR6Page, evaluation: this.evaluation, answer: this.answer});
    }
  }
